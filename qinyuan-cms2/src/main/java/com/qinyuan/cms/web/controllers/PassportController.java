...
import com.qinyuan.cms.core.CMSRuntimeException;
import com.qinyuan.cms.domain.User;
import com.qinyuan.cms.service.PassportService;
import com.qinyuan.cms.utils.AssertUtil;
import com.qinyuan.cms.web.Constant;
import com.qinyuan.cms.web.forms.UserForm;
...
public class PassportController {
	...
	@ResponseBody
	public Integer tologin(User user){
		
		User u = passportService.login(user.getUsername(), user.getPassword());
